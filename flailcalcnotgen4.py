...
# Create window
window = tk.Tk()
window.title("Flail/Reversal Calc Not Gen 4")
...
def calculate_bp(maxHP):
    ...
    bp200 = int(maxHP * 1.999999/48)
    bp150 = int(maxHP * 4.999999/48)
    bp100 = int(maxHP * 9.999999/48)
    bp80 = int(maxHP * 16.999999/48)
